    ...
    <>
      ...
      <div className="mt-32">
        <div className="flex flex-col justify-center items-center">
          <h4 className="text-center text-sky-500 text-6xl font-bold">
            Ayo Reservasi
          </h4>
          <p className="text-center text-sky-500 font-bold text-5xl mt-1">
            Sekarang!
          </p>
          <p className="text-center text-base my-7">
